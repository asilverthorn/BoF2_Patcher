class Arguments:
    def __init__(self):
        ...
        self.parser.add_argument("-i", dest = "input_file", required = True, help = "rom file")
        self.parser.add_argument("-o", dest = "output_file", required = False, help = "Modified From file")
        ...
        self.output_file = f"{name}_modified{ext}"
