...
class Space():
    ...
    def __init__(self, start_address, end_address, description, clear_value = None, allow_conflict = False):
...
def Reserve(start_address, end_address, description, clear_value = None, allow_conflict = False):
    bank_start = (start_address // BANK_SIZE) * BANK_SIZE
    heap = Space.heaps[Bank(bank_start)]
    heap.reserve(start_address, end_address)

    return Space(start_address, end_address, description, clear_value, allow_conflict)
